...
static void key_callback(GLFWwindow *window, int key, int scancode, int action, int mods)
{
	...
	// if (key == KEY_X && !mods) {
	// 	cout << "x little was pressed." << endl;
	// }
	// if (key == KEY_Y && !mods) {
	// 	cout << "y little was pressed." << endl;
	// }
	// if (key == KEY_Z && !mods) {
	// 	cout << "z little was pressed." << endl;
	// }
	// if (key == KEY_X && mods) {
	// 	cout << "x capital was pressed." << endl;
	// }
	// if (key == KEY_Y && mods) {
	// 	cout << "y capital was pressed." << endl;
	// }
	// if (key == KEY_Z && mods) {
	// 	cout << "z capital was pressed." << endl;
	// }
}
...
static void render(Body& body)
{
	...
	// 	// 	MV.rotate(1.5708, vec3(0, 0, 1));
	// 	// 	// MV.rotate(0.785398, vec3(0, 0, 1));
			// glUniformMatrix4fv(unifIDs["MV"], 1, GL_FALSE, value_ptr(MV.topMatrix()));
	// 	// 	glDrawArrays(GL_TRIANGLES, 0, indCount);
	// 	// MV.popMatrix();
	// 	// MV.pushMatrix();
	// 	// 	MV.scale(vec3(.5, 4, 1));
	// 	// 	MV.translate(vec3(-5, 0, -10));
	// 		MV.rotate(-60, vec3(0, 0, 1));
	// 		MV.scale(vec3(.5, 5, 2));
	// 		MV.translate(2.5, 0, 0);
	// 	// MV.popMatrix();
...
int main(int argc, char **argv)
{
	...
	// #ifdef __APPLE__ 
	// 	static bool macMoved = false; if(!macMoved) { int x, y; glfwGetWindowPos(getGLFWWnd(), &x, &y); glfwSetWindowPos(getGLFWWnd(), ++x, y); macMoved = true; } 
	// #endif
